...
export default {
  data() {
    return {
      waveAllHeight: 200, //波浪的整体高度
      waveCount: 4, //波浪个数
      waveHeight: 75 //波浪起伏高度
    };
  },
  mounted() {
    this.wavePlay("wave1", 80, "#f00", 1500);
    this.wavePlay("wave2", 90, "hsl(200, 97%, 61%)", 3000);
    this.wavePlay("wave3", 100, "hsl(170, 97%, 61%)", 2500);
    this.wavePlay("wave4", 60, "hsl(170, 97%, 61%)", 2000);
    this.wavePlay("wave5", 65, "hsl(170, 97%, 61%)", 2500);
  },
  methods: {
    //  * 底部波浪
